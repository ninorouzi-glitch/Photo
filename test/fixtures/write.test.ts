...
import { measurementSet, testSet } from './generate.ts';
import { encodePng } from './png.ts';

/**
 * Schreibt die Testbilder aus §13 samt der drei Messfälle als PNG nach
 * test/fixtures/out/.
...
test('Testbilder als Dateien schreiben', () => {
  ...
  for (const { id, label, frame } of [...testSet(), ...measurementSet()]) {
